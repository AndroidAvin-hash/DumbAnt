...
public class AntCrawl : Agent
{
    ...
    public override void Initialize()
    {
        ...
        m_DirToTarget = target.position - head.position;
    ...
    public override void CollectObservations(VectorSensor sensor)
    {
        ...
        RaycastHit hit;
        if (Physics.Raycast(head.position, Vector3.down, out hit, 10.0f))
        {
    ...
    public override void OnActionReceived(float[] vectorAction)
    {
        ...
        bpDict[leg5Upper].SetJointTargetRotation(vectorAction[++i], vectorAction[++i], 0);
        bpDict[leg0Lower].SetJointTargetRotation(vectorAction[++i], 0, 0);
        bpDict[leg1Lower].SetJointTargetRotation(vectorAction[++i], 0, 0);
        bpDict[leg2Lower].SetJointTargetRotation(vectorAction[++i], 0, 0);
        bpDict[leg3Lower].SetJointTargetRotation(vectorAction[++i], 0, 0);
        bpDict[leg4Lower].SetJointTargetRotation(vectorAction[++i], 0, 0);
        bpDict[leg5Lower].SetJointTargetRotation(vectorAction[++i], 0, 0);

        bpDict[head].SetJointTargetRotation(vectorAction[++i], vectorAction[++i], 0);
        bpDict[tail].SetJointTargetRotation(vectorAction[++i], vectorAction[++i], 0);
        ...
        bpDict[leg5Upper].SetJointStrength(vectorAction[++i]);
        bpDict[leg0Lower].SetJointStrength(vectorAction[++i]);
        bpDict[leg1Lower].SetJointStrength(vectorAction[++i]);
        bpDict[leg2Lower].SetJointStrength(vectorAction[++i]);
        bpDict[leg3Lower].SetJointStrength(vectorAction[++i]);
        bpDict[leg4Lower].SetJointStrength(vectorAction[++i]);
        bpDict[leg5Lower].SetJointStrength(vectorAction[++i]);

        bpDict[head].SetJointStrength(vectorAction[++i]);
        bpDict[tail].SetJointStrength(vectorAction[++i]);
    }
    ...
    {
        m_FacingDot = Vector3.Dot(m_DirToTarget.normalized, head.forward);
